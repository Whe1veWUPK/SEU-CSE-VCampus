...
public class StuStatusManageInfoUpdateDlg extends JFrame {
    ...
    public StuStatusManageInfoUpdateDlg(JSONObject json) {
        _clientID = json.getString("userId");
        init();
    }

    void init() {
        JFrame InfoInput = new JFrame("信息修改");
        ...
        jsonObject.put("role", "ST"); // 默认传一个学生
        ...
        btnControl.addActionListener(e -> {
            try {
                jsonObject.put("request", "setstat");
