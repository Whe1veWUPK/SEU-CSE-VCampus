...
public class CourseAddCourseDlg extends JFrame {
    ...
    public CourseAddCourseDlg(String userId) throws InterruptedException {
        _clientID = userId;
        init();
    }
    ...
    void init() throws InterruptedException {
        JFrame InfoInput = new JFrame("课程添加");

        // 界面大小
        InfoInput.setSize(450, 470);
        // 界面布局先设为null
        ...
        labelCourTime.setBounds(90, 280, 120, 30);
        InfoInput.add(labelCourTime);
        JPanel panel = new JPanel();
        panel.setBounds(160, 278, 280, 40);
        InfoInput.add(panel);
        // 创建星期下拉框
        ...
        labelCourTimeFinish.setBounds(167, 320, 120, 30);
        InfoInput.add(labelCourTimeFinish);
        JPanel panelFinish = new JPanel();
        panelFinish.setBounds(195, 318, 280, 40);
        ...
        btnControl.setBounds(120, 370, 150, 30);
        ...
        btnControl.addActionListener(e -> {
            try {
                jsonObject.put("request", "addcour");
                ...
                switch (res.getString("code")) {
                    ...
                    case "2":
                        ...
                        break;
                    case "3":
                        JOptionPane.showMessageDialog(this, "课程已存在", "错误", JOptionPane.ERROR_MESSAGE);
                        break;
                    case "-1":
