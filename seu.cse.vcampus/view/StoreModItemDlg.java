...
public class StoreModItemDlg extends JFrame {
    ...
    private String _ModItemId;

    public StoreModItemDlg(JSONObject jsonObject,String ModItemId){
        this._jsonObject=jsonObject;
        this._ModItemId=ModItemId;
        init();
    }

    void init(){
        JFrame InfoInput = new JFrame("商品信息修改");
        ...
        btnControl.addActionListener(e -> {
            try {
                ...
                _jsonObject.put("itemid", this._ModItemId);
